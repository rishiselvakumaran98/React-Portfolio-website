        ...
        <section id="first" class="main special">
          ...
          <ul class="features">
            ...
            <li>
              ...
              <h3>MyTeacher GPT</h3>
              <p><em>OpenAI API, Prompt Engineering, React.js</em></p>
              <p>
            ...
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/color/96/000000/commercial-development-management.png"/></span>
              <h3>Employee management App</h3>
              <p><em>React Hooks, Spring Boot, Maven, MySQL</em></p>
              <p>
            ...
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/color/96/000000/drone-with-camera.png"/></span>
              <h3>3D Drone Delivery Simulation</h3>
              <p><em>C++, WebGL, Three.js, JavaScript</em></p>
              <p>
            ...
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/nolan/96/google-scholar.png"/></span>
              <h3>CS Insiders</h3>
              <p><em>HTML, CSS, Express.js, MongoDB</em></p>
              <p>
            ...
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/color/96/000000/four-squares.png"/></span>
            ...
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/color/96/000000/todo-list.png"/></span>
              <h3>Todo-List</h3>
            ...
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/color/96/000000/hard-to-find.png"/></span>
              <h3>Magical Maze</h3>
              <p><em>Java</em></p>
            ...
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/color/96/000000/battleship.png"/></span>
              <h3>Battleboats Game</h3>
              <p><em>Java</em></p>
              <p>A Battleboats game in Java? Yep, you heard that right! A single/multi-player game, where player(s) take turn to enter coordinates to destroy ships in this fun and exciting game that will test your understanding of coordinate system.</p>
              <a href="https://rishiselvakumaran98.github.io/Battle-boats/" class="button">Learn More</a>
            </li>
            <li>
              <span class="icon"><img style={{width: '64px', height: '64px', objectFit: 'contain'}} src="https://img.icons8.com/fluent/96/000000/resume-website.png"/></span>
              <h3>This website</h3>
              <p><em>React.js, Gatsby, GitHub Pages</em></p>
              <p>
                Hey! If you are browsing through this website, this was built by me using React, GatsbyJS, and hosted in GitHub Pages. If you like this website, or would like to know more about me send me a nice email under 'Contact me'. 😆
              </p>
              <a href="https://github.com/rishiselvakumaran98/Portfolio-website" class="button">Learn More</a>
            </li>
          </ul>
          <footer class="major">
          </footer>
